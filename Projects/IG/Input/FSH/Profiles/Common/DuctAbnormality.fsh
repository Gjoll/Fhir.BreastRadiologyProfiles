...
* component contains ductType 0..1
* component[ductType] ^short = "Duct Abnormality component."
* component[ductType] ^comment = """
...
* component[ductType].value[x] from DuctAbnormalityTypeVS
