...
* component contains lymphNodeType 1..1
* component[lymphNodeType] ^short = "Lymph Node Abnormality Type component."
* component[lymphNodeType] ^comment = """
    This is one component of a group of components that are part of the observation.
    """
* component[lymphNodeType] ^definition = """
    This slice contains the optional component that refine the Lymph Node Abnormality type.
    The value of this component is a codeable concept chosen from the AbnormalityLymphNodeTypeVS valueset.
    """
* component[lymphNodeType].code 1..1
* component[lymphNodeType].code ^short = "Lymph Node Abnormality Type component code."
* component[lymphNodeType].code ^definition = """
    This code identifies the Lymph Node Abnormality Type component.
    """
* component[lymphNodeType].code = ObservationComponentSliceCodesCS#abnormalityLymphNodeType
